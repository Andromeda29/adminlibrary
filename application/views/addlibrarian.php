...
echo form_open('home/addLibrarian','class=forma');
echo '<div class="form-group">';
echo form_label('Имя библиотекаря', 'fname');
echo form_input(array('name'=>'fname','size'=>'50','class'=>'form-control','value'=>set_value('fname')));
echo '</div>';
echo '<div class="form-group">';
echo form_label('Фамилия библиотекаря', 'lname');
echo form_input(array('name'=>'lname','size'=>'50','class'=>'form-control','value'=>set_value('lname')));
echo '</div>';
echo '<div class="form-group">';
echo form_label('Email библиотекаря', 'email');
echo form_input(array('name'=>'email','size'=>'50','class'=>'form-control','value'=>set_value('email')));
echo '</div>';
echo '<div class="form-group">';
